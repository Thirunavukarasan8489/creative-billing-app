...
export async function GET(req: NextRequest) {
  try {
    ...
    // Fetch all invoices in that month including cancelled ones, sorted by sequence/number ascending
    ...
    // Only active (non-cancelled) bills are included in total revenue & tax sums
